...
export default function UserTimelinePage() {
  ...
  async function fetchData() {
    try {
      // Fetch public entries for this user
              ...
              <div key={year} className="relative mb-12">
                ...
                <div className="ml-20 space-y-6">
                  {grouped[year].map(entry => (
                    <div key={entry.id} className="bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.06)] p-6 hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300">
